                        ...
                        double weight, unsigned int n)
{
    ...
    //    cout << kd << endl;
    //    cout << Rg_ex - Rgc << endl;
    REQUIRE(Rg_ex== Approx(Rgc).epsilon(1e-3));
}
