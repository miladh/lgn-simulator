...
TEST_CASE("runSystemTest_GRIC_2"){
    int ns = 6;
    int nt = 4;
    double dt = 5;
    double ds = 0.1;
...
//*****************************************************************************************
TEST_CASE("runSystemTest_GRIC_0"){
    double dt = 0.1;
    double ds = 0.1;
    double w_w = 1.0;
    double w_cr = 1.0;
    ...
    SpatialGaussian Kri_s( 0.23);
    TemporalDelta Kri_t(0, dt);
    SeparableKernel Kri(w_ri, &Kri_s, &Kri_t);

    SpatialDelta Kig_s(ds, {0,0});
    TemporalDelta Kig_t(0, dt);
    SeparableKernel Kig(w_ig, &Kig_s, &Kig_t);

    SpatialGaussian Kic_s( 0.23);
    TemporalDelta Kic_t(0, dt);
    SeparableKernel Kic(w_ic, &Kic_s, &Kic_t);
...
TEST_CASE("runSystemTest_GRIC_1"){
    double dt = 0.1;
    double ds = 0.1;
    double w_w = 1.0;
    double w_cr = -1.5;
